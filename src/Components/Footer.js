import myImage from '../Components/istockphoto-520369192-612x612.jpg';  
...
function Footer (){
    ...
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid grid-cols-2 gap-x-5 gap-y-12 md:grid-cols-4 md:gap-x-12">
            <div>
                <p class="text-base text-gray-500">Somali Voting App</p>
            ...
            <div>
                <p class="text-base text-gray-500">Qeybta Caawimaada</p>
            ...
            <div>
                <p class="text-base text-gray-500">Faahfaahin</p>
        ...
        <div class="flex flex-wrap items-center justify-between">
            {<img class="h-8 auto md:order-1" src="{myImage}" alt="" /> }
            ...
            <p class="w-full mt-8 text-sm text-center text-gray-100 md:mt-0 md:w-auto md:order-2">© Copyright 2021, All Rights Reserved by Somali Goverment</p>
        </div>
    </div>
</section>
